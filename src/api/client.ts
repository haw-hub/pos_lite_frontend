...
const getBaseUrl = (): string => {
  ...
  if (__DEV__) {
    ...
    if (Platform.OS === 'android') {
      ...
      console.log('📱 Using Physical Device - Connecting to:', 'http://192.168.0.105:8080/api');
      return 'http://192.168.0.105:8080/api';

    }
    
    // iOS simulator
    if (Platform.OS === 'ios') {
      console.log('📱 Using iOS Simulator - Connecting to:', 'http://192.168.0.105:8080/api');
      return 'http://192.168.0.105:8080/api';
    }
  }
